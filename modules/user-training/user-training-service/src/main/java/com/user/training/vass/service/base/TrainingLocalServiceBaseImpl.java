...
import com.user.training.vass.service.TrainingLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.user.training.vass.service.impl.TrainingLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.user.training.vass.service.impl.TrainingLocalServiceImpl
 * @generated
 */
public abstract class TrainingLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TrainingLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.user.training.vass.service.TrainingLocalServiceUtil</code>.
	 */
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TrainingLocalServiceImpl#deleteTraining(Training) to avoid orphaned data");
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TrainingLocalServiceBaseImpl.class);
